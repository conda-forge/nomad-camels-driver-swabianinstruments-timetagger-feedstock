About nomad-camels-driver-swabianinstruments-timetagger-feedstock
=================================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-camels-driver-swabianinstruments-timetagger-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-camels-driver-swabianinstruments-timetagger-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-camels-driver-swabianinstruments-timetagger
# for installing globally
pixi global install nomad-camels-driver-swabianinstruments-timetagger
```
...
It is possible to list all of the versions of `nomad-camels-driver-swabianinstruments-timetagger` available on your platform:
...
```
pixi search nomad-camels-driver-swabianinstruments-timetagger --channel conda-forge
```
